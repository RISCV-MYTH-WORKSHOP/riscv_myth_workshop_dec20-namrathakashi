...
\TLV
   ...
   |cpu
      ...
      @1
         ...
         //Decoding the type of instruction based on bits [6:2]
         //Opcode is 6:0 and for RV64I architecture, bits 1 and 0 are 1
         ...
         //RV32I Base Instruction Set decode (selected few)
         ...
         //Adding the remainder of the RV32I base Instruction set
   ...
   //*passed = *cyc_cnt > 300;
   *passed = |cpu/xreg[17]>>10$value == 45;
   *failed = 1'b0;
