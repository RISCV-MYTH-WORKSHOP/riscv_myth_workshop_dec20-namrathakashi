...
//Lab5 - 2-cycle Calculator with Validity
   ...
   |calc
      ...
      ?$reset_or_valid
         @1
            ...
            $quot[31:0] = $val1 / $val2;
         @2
            $mem[31:0] = $reset ? 32'b0 : (($op[2:0] == 3'b101) ? $out : >>1$mem);
            $recall[31:0] = >>1$mem[31:0];
            $out[31:0] = $reset ? 32'b0 : (($op[2:0] == 3'b000) ? $sum  :
                                          (($op[2:0] == 3'b001) ? $diff :
                                          (($op[2:0] == 3'b010) ? $prod :
                                          (($op[2:0] == 3'b011) ? $quot :
